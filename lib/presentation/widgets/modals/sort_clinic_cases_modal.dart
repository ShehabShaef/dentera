...
class SortClinicCasesModal extends ConsumerWidget {
  const SortClinicCasesModal({
    super.key,
  ...
  /// Convenience static helper to display the [SortClinicCasesModal].
  static Future<ClinicRequirementSortOption?> show(
    BuildContext context, {
    required String clinicId,
  }) {
    AppLogger.info('Opened SortClinicCasesModal for clinic: $clinicId');
    return showModalBottomSheet<ClinicRequirementSortOption>(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => SortClinicCasesModal(clinicId: clinicId),
    );
  }

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final currentSort = ref.watch(clinicRequirementSortOptionProvider(clinicId));
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ...sortOptions.map((item) {
              final option = item['option'] as ClinicRequirementSortOption;
              ...
              return Padding(
                ...
                child: Material(
                  ...
                  child: InkWell(
                    onTap: () {
                      AppLogger.info('Changed clinic requirement sort option to: ${option.name}');
                      ref.read(clinicRequirementSortOptionProvider(clinicId).notifier).state = option;
